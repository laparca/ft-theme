...
$fields =  array(
	'author' => '<p><input type="text" name="author" id="author" value="" size="22" tabindex="1" aria-required="true" /><label for="author"><small> Nombre</small></label></p>',
	'email'  => '<p><input type="text" name="email" id="email" size="22" tabindex="2" aria-required="true" /><label for="email"><small> Correo-e (no se mostrar&aacute;)</small></label></p>',
	'url'    => '<p><input type="text" name="url" id="url" size="22" tabindex="3" /><label for="url"><small> P&aacute;gina web</small></label></p>'
); 
...
<?php else : // this is displayed if there are no comments so far ?>
	...
	<div id="commentbox">
	<p>A&uacute;n no hay comentarios, se el primero en escribir uno.</p>
	<?php
